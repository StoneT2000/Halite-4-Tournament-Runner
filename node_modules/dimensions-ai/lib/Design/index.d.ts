...
export declare abstract class Design {
     ...
     */
    constructor(name: String, designOptions?: DeepPartial<DesignOptions>);
    /**
     ...
     */
    abstract update(match: Match, commands: Array<Command>): Promise<Match.Status>;
    /**
     ...
     */
    static createCustom(name: string, overrideOptions: DeepPartial<Design.OverrideOptions>): CustomDesign;
}
/**
 ...
 * competition running
 */
declare class CustomDesign extends Design {
 ...
 */
export declare const DefaultDesignOptions: DesignOptions;
export declare module Design {
    /**
