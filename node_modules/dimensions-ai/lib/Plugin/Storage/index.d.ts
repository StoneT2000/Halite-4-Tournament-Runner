...
export declare abstract class Storage extends Plugin {
    /** Default configs */
     ...
     */
    abstract uploadTournamentFile(file: string, user: Database.User, tournament: Tournament): Promise<string>;
    /**
     ...
     */
    abstract uploadUserFile(file: string, userID: nanoid, destinationName: string): Promise<string>;
    /**
     ...
     */
    abstract download(key: string, destination: string): Promise<any>;
    /**
