...
class Variable extends mathematics_1.SkillGaussian {
    constructor() {
        super(...arguments);
        this.messages = {};
    }
    ...
    updateMessage(factor, pi = 0, tau = 0, message) {
        const newMessage = message ? message : new mathematics_1.SkillGaussian(null, null, pi, tau);
    ...
    updateValue(factor, pi = 0, tau = 0, value) {
        if (!value) {
            value = new mathematics_1.SkillGaussian(null, null, pi, tau);
        }
...
class Factor {
    constructor(vars) {
        ...
        vars.forEach(v => {
            v.messages[k] = new mathematics_1.SkillGaussian();
        });
    }
    down() {
        return 0;
...
class PriorFactor extends Factor {
    ...
    down() {
        ...
        const value = new mathematics_1.SkillGaussian(this.val.mu, sigma);
